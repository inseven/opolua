...
public:
    ...
    void run(const QDir& cDrive, const QString& devicePath);
    void runOpo(const QString& path);
    void runInstaller(const QString& file, const QString& dest);
